...
export const metadata: Metadata = {
  title: "News Applied AI | AI-Powered Newsletter",
  description:
  ...
  authors: [{ name: "News Applied AI Team" }],
  openGraph: {
    title: "News Applied AI: Your Source for AI Innovations",
    description:
    ...
    siteName: "News Applied AI",
    images: [
      {
        url: "https://newsappliedai.com/opengraph-image.png",
        width: 1200,
        height: 630,
        alt: "News Applied AI Newsletter Preview",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "News Applied AI: AI Innovations at Your Fingertips",
    description:
  ...
  //   },
  other: {
    "application-name": "News Applied AI",
  },
};
